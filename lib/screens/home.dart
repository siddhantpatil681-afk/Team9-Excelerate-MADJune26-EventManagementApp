...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  // The dynamic list containing the user's active events
  final List<EventModel> _events = [];
  // Key used to control the insertion/removal animations inside the SliverAnimatedList
  ...
  // Get current filtered items based on search row input
  ...
  // Helper logic to cleanly insert events with fluid slide-and-fade mechanics
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // Add Event Action Button + Notification Bell Tuple
                    Row(
                      children: [
                        IconButton(
            ...
            // ── Dynamic Layout Switcher (Empty State vs Event Display) ────────
            if (_events.isEmpty)
              SliverFillRemaining(
                hasScrollBody: false,
              ...
              // ── Fluid Animated List Implementation ──────────────────────────
              SliverAnimatedList(
                key: _listKey,
                ...
                itemBuilder: (context, index, animation) {
                  ...
                  // Slide and Fade animation combined
      ...
      bottomNavigationBar: Container(
        decoration: const BoxDecoration(border: Border(top: BorderSide(color: const Color(0xFF2C2C2C), width: 1)), color: Color(0xFF121212)),
...
class _EventListTile extends StatelessWidget {
  ...
  const _EventListTile({required this.event, required this.onSavedToggle});
